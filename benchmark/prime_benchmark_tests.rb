...
# These tests confirm that the big O for this task is O(m * sqrt(m))
# Each test case increased the total CPU time by a factor of about 32
...
# test case 4: m = 10000000 (increased by factor of 10)
